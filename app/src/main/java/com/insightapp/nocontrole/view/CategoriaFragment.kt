...
import com.insightapp.nocontrole.viewmodel.ui.categoria.CategoriaAdapter
    ...
    override fun onCreateView(
        ...
        val adapter = context?.let {
            CategoriaAdapter(
                it,
                object :
                    CategoriaAdapter.ItemSelectedListener {
                    ...
                    override fun onItemSelectedAlt(item: Categoria) {
                        val mDialogView =
                            LayoutInflater.from(context).inflate(R.layout.dialog_new_categ, null)
                        val mBuilder =
